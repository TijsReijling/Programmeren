...
[URL 0f the data download page]((https://statline.rivm.nl/portal.html?_la=nl&_catalog=RIVM&tableId=50132NED&_theme=101)) + Metadata

```{r}
head("Ervarengezondheid_Wijk&Buurt")
```
...
```{r gen_var1, eval=FALSE, include=FALSE}
...
```{r visualise_subpopulations, eval=FALSE, include=FALSE}
...
```{r Event_analysis, eval=FALSE, include=FALSE}
