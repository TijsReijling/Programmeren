...
```{r Isolate_both_datasets_for_2015_2018}
...
Similarly, Rotterdam’s reported perceived health in 2012 and 2016, respectively, was 70.5% and 68.4%, in contrast to Amsterdam’s perceived health, dropping a handful of points throughout the 4 years. The municipality of Rotterdam had started its initiative, organized by VITR in collaboration with Erasmus, Hogeschool Rotterdam, and other health-focused institutes. Similarly to Amsterdam’s initiative results, the perceived health drastically increased from 68.4% in 2016 to 74.1% in 2020, showcasing a clear positive reaction by the general public towards the initiatives.
